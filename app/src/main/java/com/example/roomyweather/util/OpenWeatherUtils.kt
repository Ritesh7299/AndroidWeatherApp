...
fun getTempUnitsDisplay(units: String?, context: Context) : String {
    return when (units) {
        ...
        context.getString(R.string.pref_units_value_imperial) -> context.getString(R.string.imperial_temp_display)
        else -> context.getString(R.string.standard_temp_display)
    }
}
