...
class MainActivity : AppCompatActivity() {
    ...
    private val viewModel2: LookedUpCitiesViewModel by viewModels()
    private val forecastAdapter = ForecastAdapter(::onForecastItemClick)
    //private val city1: LookUpCity? = null
...
//        viewModel.forecast.observe(this) {forecast ->
//            if (forecast != null) {
//                val name = forecast.city.name
//
//            }
//        }

        val city1 = LookUpCity(city.toString(), System.currentTimeMillis())

        viewModel2.addLookedUpCity(city1)
